...
lv_obj_t *ui_ScrRadioPlayer = NULL;lv_obj_t *ui_CntnrTime = NULL;lv_obj_t *ui_LblHrs = NULL;lv_obj_t *ui_LblMin = NULL;lv_obj_t *ui_LblDots = NULL;lv_obj_t *ui_LblDate = NULL;lv_obj_t *ui_CntnrWeather = NULL;lv_obj_t *ui_ImgDayClear = NULL;lv_obj_t *ui_ImgCloudy = NULL;lv_obj_t *ui_LblWeather = NULL;lv_obj_t *ui_CntnrButtons = NULL;lv_obj_t *ui_Button1 = NULL;lv_obj_t *ui_Container1 = NULL;lv_obj_t *ui_Button2 = NULL;lv_obj_t *ui_Container2 = NULL;lv_obj_t *ui_Button3 = NULL;lv_obj_t *ui_Container3 = NULL;lv_obj_t *ui_Button4 = NULL;lv_obj_t *ui_Container4 = NULL;lv_obj_t *ui_Button5 = NULL;lv_obj_t *ui_Container5 = NULL;lv_obj_t *ui_CntnrRadio = NULL;lv_obj_t *ui_LblStation = NULL;lv_obj_t *ui_LblCurPlaying = NULL;lv_obj_t *ui_PnlHorLine = NULL;lv_obj_t *ui_PnlVerLine = NULL;lv_obj_t *ui_SldrVolume = NULL;lv_obj_t *ui_Container6 = NULL;lv_obj_t *ui_Button6 = NULL;lv_obj_t *ui_Label1 = NULL;lv_obj_t *ui_Button7 = NULL;lv_obj_t *ui_Label2 = NULL;lv_obj_t *ui_Button8 = NULL;lv_obj_t *ui_Label3 = NULL;
// event funtions
...
lv_obj_remove_flag( ui_LblCurPlaying, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE | LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLL_MOMENTUM | LV_OBJ_FLAG_SCROLL_CHAIN );    /// Flags
...
if (lv_obj_get_style_pad_top(ui_SldrVolume,LV_PART_MAIN) > 0) lv_obj_set_style_pad_right( ui_SldrVolume, lv_obj_get_style_pad_right(ui_SldrVolume,LV_PART_MAIN) + 1, LV_PART_MAIN );
