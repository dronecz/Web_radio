...
///////////////////// VARIABLES ////////////////////
lv_anim_t * VolumeHide_Animation(lv_obj_t * TargetObject, int delay);
...
void ui_init(void)
{
    ...
    ui_ScrRadioPlayer_screen_init();
    ui_ScrMusicPlayer_screen_init();
    ui_ScrNetworkPlayer_screen_init();
    ui_ScrWiFiManager_screen_init();
...
{
    ui_ScrBoot_screen_destroy();
    ui_ScrRadioPlayer_screen_destroy();
    ui_ScrMusicPlayer_screen_destroy();
    ui_ScrNetworkPlayer_screen_destroy();
    ui_ScrWiFiManager_screen_destroy();
}
