...
void ui_MainScr_screen_init(void)
{
    ...
    lv_obj_remove_flag(ui_MainScr, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_MainScr, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_MainScr, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_CntnrTime = lv_obj_create(ui_MainScr);
    ...
    lv_obj_set_width(ui_ImgDayClear, LV_SIZE_CONTENT);   /// 128
    ...
    lv_obj_set_y(ui_LblWeather, 40);
    lv_obj_set_align(ui_LblWeather, LV_ALIGN_CENTER);
    lv_label_set_text(ui_LblWeather, "4 - 8 / -2 - -5 °C");
    lv_obj_set_style_text_font(ui_LblWeather, &ui_font_Roboto_Reg_18, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_CntnrButtons = lv_obj_create(ui_MainScr);
    ...
    lv_obj_set_style_bg_color(ui_Container1, lv_color_hex(0x37FF00), LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    lv_obj_set_style_bg_color(ui_Container2, lv_color_hex(0x37FF00), LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    lv_obj_set_style_bg_color(ui_Container3, lv_color_hex(0x37FF00), LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    lv_obj_set_style_bg_color(ui_Container4, lv_color_hex(0x37FF00), LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    lv_obj_set_style_bg_color(ui_Container5, lv_color_hex(0x37FF00), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_bg_opa(ui_Container5, 255, LV_PART_MAIN | LV_STATE_CHECKED);

    ui_CntnrRadio = lv_obj_create(ui_MainScr);
    lv_obj_remove_style_all(ui_CntnrRadio);
    lv_obj_set_height(ui_CntnrRadio, 130);
    ...
    lv_obj_set_style_text_font(ui_LblStation, &ui_font_Roboto_Reg_28, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_y(ui_LblCurPlaying, 5);
    ...
    lv_obj_set_style_text_font(ui_LblCurPlaying, &ui_font_Roboto_Reg_18, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_PnlHorLine = lv_obj_create(ui_MainScr);
    ...
    ui_PnlVerLine = lv_obj_create(ui_MainScr);
    ...
    ui_SldrVolume = lv_slider_create(ui_MainScr);
    ...
    lv_obj_set_style_bg_image_opa(ui_SldrVolume, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
